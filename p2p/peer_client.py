        ...
        for IP in content:
            if IP.strip() and is_valid_IP(IP):
                try:
                    ...
                    peer_client_sock.sendto(get_super_peer.encode(),(UDP_IP, UDP_PORT))
                    if debug:
                        print("Peer Client sent get_super_peer")
        ...
        for IP in content:
            if IP.strip() and is_valid_IP(IP):
                try:
                    ...
                    peer_client_sock.sendto(get_peer.encode(),(UDP_IP, UDP_PORT))
                    if debug:
                        print("Peer Client sent get_peer")
        ...
        for IP in content:
            if IP.strip() and is_valid_IP(IP):
                try:
                    ...
                    if debug:
                        print("Peer Client Added itself to Super Peer " + str(IP).strip())
                except:
                    pass
        ...
        for IP in content:
            if IP.strip() and is_valid_IP(IP):
                try:
                    ...
                    if debug:
                        print("Peer Client Removed itself from Super Peer " + str(IP).strip())
                except:
                    pass
